...
<div class = "main-grid">
  <div class = "agile-grids">
    <div class = "progressbar-heading grids-heading">
      ...
      <h2> <i class="fa fa-envelope"></i> Sent Messages</h2>
      <?php 
  ...
  <div class = "codes">
    <div class = "agile-container">
      <a href="<?=site_url('main/messages')?>" class="btn btn-default bg-dark "><i class="fa fa-download"></i> Recieved</a>
      <a href="<?=site_url('main/sent')?>" class="btn btn-primary disabled"><i class="fa fa-upload"></i> Sent</a>
...
<!--END MODAL EDIT-->
      ...
      <table class="agile-container table table-hover">
        ...
        <tr>
          <?php 
        $loadMessages=$this->db->query("SELECT * FROM messages INNER JOIN users ON users.userID = messages.sender WHERE messages.sender = {$userID} ORDER BY time_read DESC");
                 foreach($loadMessages->result() as $rowMessages) {
                      $sendername=$this->db->query("SELECT * FROM users WHERE userID ={$rowMessages->reciever}");
