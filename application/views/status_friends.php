...
<div class = "main-grid">
	<div class = "agile-grids">
		<div class = "progressbar-heading grids-heading">
			<h2> <i class="fa fa-book"></i> Search</h2>
			<?php 
	...
	<div class = "codes">
        ...
        <div class="card">
              ...
              <h2 class="font-white"><?=$rowUsers->Fname?> <?=$rowUsers->Mi?>. <?=$rowUsers->Lname?></h2>
              <br>
              <div class="react">
                <?php
               $queryVerifyConnection=$this->db->query("SELECT * FROM connection where requestor = '{$userID}' and acceptor='{$rowUsers->userID}'");
                 if ($queryVerifyConnection->num_rows()>0){
                 echo"<a href = 'abortRequest/$rowUsers->userID'><i class='fa fa-minus'></i> ABORT CONNECTION</a>";
                }else{
                 echo"<a href = 'requestConnection/$rowUsers->userID'><i class='fa fa-plus'></i> CONNECT</a>";
                  }?>
