...
<div class = "main-grid">
	<div class = "agile-grids">
		<div class = "progressbar-heading grids-heading">
			...
			<h2> <i class="fa fa-user"></i> Request Connections</h2>
      <?php 
  ...
  echo "<div><p class='message center-block text-center bg-primary'>" . $message . "</p></div>";
	...
	<div class = "codes">
      ...
      <?php 
          $con=$this->db->query("SELECT * FROM connection LEFT JOIN users ON(connection.requestor = users.userID) WHERE connection.acceptor={$userID} and is_confirm = 0");
          foreach ($con->result() as $list):
         ?>
      <div class="card">
        
         <h2 class="font-white"><?=$list->Fname?> <?=$list->Mi?>. <?=$list->Lname?></h2>
              <br>
              <div class="react">
                <a href = "request_confirm/<?=$list->userID?>"><i class="fa fa-plus"></i> Accept </a>
                &nbsp; &nbsp;
                <a href = "ignoreRequest/<?=$list->userID?>"><i class="fa fa-minus"></i> Ignore</a>
